DROP FUNCTION IF EXISTS public.search_parts_ranked(text,text,text,text,text,int,numeric,numeric,text,int);
...
GRANT EXECUTE ON FUNCTION public.search_parts_ranked(text,text,text,text,text,int,numeric,numeric,text,int,int)
